...
from medical_file.views import MedicalFilesViewSet
...
urlpatterns = [
    ...
    path('medfile/', include("medical_file.routing")),
    path('medrecord/', include("medical_record.routing")),
    # path('files/<str:mode>/<str:national_code>/', MedicalFilesViewSet.as_view()),
]
