...
class MedicalFile(models.Model):
    """
    This represents a specific period of aid, a visit, or a sub-file within the master record.
    This is where your VAS scores live.
    """
    # PARENT LINK: Links back to the master MedicalRecord
    medical_record = models.ForeignKey(
        MedicalRecord,
        on_delete=models.CASCADE,
        related_name='files' # Easy access: medical_record.files.all()
    )
    ...
    def __str__(self):
        return f"File entry: {self.date_of_file} (VAS: {self.vas_score})"
